...
console.log("Token:", access_token ? "✅ obtained" : "❌ failed");

const res = await fetch(
  `https://youtubeanalytics.googleapis.com/v2/reports?ids=channel==MINE&startDate=2026-05-01&endDate=2026-05-28&metrics=views,estimatedMinutesWatched,averageViewPercentage,averageViewDuration,subscribersGained,subscribersLost`,
